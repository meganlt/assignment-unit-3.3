...
for ( i=0; i<supplyChanges.length; i++ ){
  if( supplyChanges[i] > 0 ){
    ...
    console.log( 'Not a positive, negative, or zero number');
  }
}
console.log( 'All positive numbers:', positives );
console.log( 'All negative numbers:', negatives );
console.log( 'All zero numbers:', zeroes );
...
console.log( 'All stretch positive numbers:', stretchPositives );
console.log( 'All stretch negative numbers:', stretchNegatives );
console.log( 'All stretch zero numbers:', stretchZeroes );
...
console.log('Total parts are now:', totalParts );
...
while( parts > 6 ){
  // if there are enough left to go into a box,
  // fill another box and subtract 7 from parts
  boxesFilled += 1;
  parts = parts - 7;
}
console.log('The number of boxes filled are:', boxesFilled);
console.log('The remaining number of parts are:', parts);
